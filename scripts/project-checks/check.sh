...
require_pattern scripts/macos/run-app-smoke.sh 'CODEX_PULSE_GROK_HOME=' DATA-001 docs/test/native-primary-pages.md
require_pattern scripts/macos/run-app-smoke.sh 'sources=8 .*dashboard_providers=3 .*dashboard_tokens=.*api_subscriptions=deepseek_unconfigured\\\+opencode_go_unconfigured .*ui_pages=10' SWIFT-003 docs/test/native-primary-pages.md
