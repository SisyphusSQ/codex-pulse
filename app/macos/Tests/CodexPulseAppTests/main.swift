...
private actor FakeCore: AppCoreServing {
    ...
    func listSessions(
        ...
        let isOverviewRequest = request.query.page.limit == 10
...
private func testAppRuntimeUsesWeeklyQuotaRangeForOverview() async throws {
    ...
    try expect(
        sessionRequests[0].query.page.limit == 10
...
private func testOverviewRangeResolutionDrivesEveryContentRequest() throws {
    ...
    try expect(requests.sessions.query.page.limit == 10, "overview sessions must stay bounded")
