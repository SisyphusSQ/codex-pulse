...
struct ContractTestMain {
    static func main() async throws {
        try expect(CodexPulseTransportContract.version, "core-rpc-v7", "contract version")
        ...
        do {
            ...
            throw TestFailure.mismatch("legacy helper handshake was accepted")
        } catch let error as CoreClientError {
            try expect(
                error,
                .incompatibleContract(expected: "core-rpc-v7", actual: "core-rpc-v2"),
