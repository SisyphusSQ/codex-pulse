...
当前仓库已经完成 Go Helper 基础层：Go 进程独占业务事实和 SQLite，通过认证后的 gRPC over Unix Domain Socket 暴露 `codexpulse.core.v1.CoreService`。SwiftUI/AppKit 客户端、`.app` 组装、嵌套签名、公证、更新安装和真实跨进程 E2E 仍是后续工作。
