...
func NewStreamParser(config ParserConfig) (*StreamParser, error) {
	...
	case source.SourceKindSession, source.SourceKindArchivedSession:
	case source.SourceKindSessionIndex:
...
func validSeedSession(session *SessionMetaFact, sourceKind source.SourceKind) bool {
