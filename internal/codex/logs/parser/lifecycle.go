...
func newLifecycleNormalizer(sourceKinds ...source.SourceKind) *lifecycleNormalizer {
	sourceKind := source.SourceKindSession
...
func sessionFact(record *decodedLine, sourceKind source.SourceKind) SessionMetaFact {
