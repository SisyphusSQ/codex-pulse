...
func TestEnsureApplicationSchemaCreatesStrictRuntimeTables(t *testing.T) {
	...
	wantTables := []string{
		...
		"cursor_tool_events",
		"cursor_usage_events",
		"grok_billing_quota_observations",
		"grok_billing_snapshots",
		"grok_session_lineage",
		"grok_sessions",
		"grok_tool_events",
		"grok_usage_events",
		"health_events",
...
func TestRuntimeSchemaColumnsForeignKeysAndIndexes(t *testing.T) {
	...
	wantColumns := map[string][]string{
		...
		"grok_billing_snapshots": {
			"provider", "generation", "collected_at_ms", "period_type", "period_start_ms", "period_end_ms",
			"used_percent", "on_demand_used", "on_demand_cap", "prepaid_balance", "subscription_tier",
			"is_unified_billing",
		},
		"grok_session_lineage": {
			"session_id", "source_key", "lineage_key", "content_digest", "observed_at_ms",
		...
		"grok_sessions": {
			"id", "provider", "external_session_id", "display_title", "title_source", "project_key",
			"project_display_name", "created_at_ms", "last_activity_at_ms", "model_key", "request_count",
			"tool_call_count", "lineage_conflict", "coverage_state", "updated_at_ms",
		},
		"grok_tool_events": {
			"event_id", "external_session_id", "occurred_at_ms", "tool_name", "outcome", "provenance", "updated_at_ms",
		},
		"grok_usage_events": {
			"event_id", "external_session_id", "occurred_at_ms", "model_key", "input_tokens", "output_tokens",
			"cached_read_tokens", "cache_creation_tokens", "reasoning_tokens", "total_tokens",
			"reported_cost_micros", "provenance", "updated_at_ms",
		},
		"light_index_state": {
			"state_id", "home_path", "home_device_id", "home_inode", "metadata_generation",
			"metadata_ready_at_ms", "token_scan_generation", "token_scan_state",
			"token_scan_started_at_ms", "token_scan_finished_at_ms", "updated_at_ms",
		},
		"light_invocation_events": {
			"session_id", "generation", "source_offset", "event_ordinal", "observed_at_ms",
			"kind", "name", "source", "outcome", "duration_ms",
		},
		"light_sessions": {
			"session_id", "thread_name", "cwd", "rollout_path", "created_at_ms", "updated_at_ms",
			"recency_at_ms", "metadata_generation", "active_token_generation",
			"pending_token_generation", "scan_state", "row_updated_at_ms",
		},
		"light_token_scans": {
			"session_id", "generation", "rollout_path", "source_file_id", "home_path", "home_device_id", "home_inode",
			"file_device_id", "file_inode", "file_size_bytes", "file_mtime_ns", "prefix_bytes",
		...
		"codex_subscription_detected_accounts": {
			...
			"automatic_plan_observed_at_ms", "revision",
		},
		"codex_subscription_manual_entries": {
			"manual_entry_id", "email", "email_match_key", "alias", "manual_plan",
			"membership_date", "date_kind", "revision", "created_at_ms", "updated_at_ms",
		},
		"codex_subscription_links": {
			"account_scope", "manual_entry_id", "revision", "linked_at_ms", "updated_at_ms",
		},
	}
	wantForeignKeys := []string{
		...
		"light_invocation_events.generation->light_token_scans.generation/CASCADE",
		"light_invocation_events.session_id->light_token_scans.session_id/CASCADE",
		"light_token_daily.generation->light_token_scans.generation/CASCADE",
		"light_token_daily.session_id->light_token_scans.session_id/CASCADE",
	...
	wantIndexes := []string{
		...
		"idx_codex_subscription_detected_email_match",
		"idx_codex_subscription_manual_email_match",
		"idx_codex_subscription_manual_updated",
		...
		"idx_grok_sessions_activity",
		"idx_grok_sessions_project",
		"idx_grok_tools_time",
		"idx_grok_usage_time",
		...
		"idx_light_invocation_kind_name",
		"idx_light_invocation_observed",
		"idx_light_sessions_cwd",
		...
		"idx_quota_observations_projection",
